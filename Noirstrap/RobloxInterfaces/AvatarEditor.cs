...
using Noirstrap.Models.APIs.Roblox;
using Noirstrap.Models.RobloxApi;

namespace Noirstrap.RobloxInterfaces
{
    public static class AvatarEditor
    {
        ...
        {
            if (!CookieAccess)
                return (false, "Noirstrap needs permission to use your Roblox login first.");
        ...
        {
            if (!CookieAccess)
                return (false, "Noirstrap needs permission to use your Roblox login first (see above).");

            if (assetIds.Count == 0)
                return (false, "Noirstrap won't send an empty outfit - equip something else first.");
