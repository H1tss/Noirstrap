...
namespace Noirstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Noirstrap-QA";
#else
        public const string ProjectName = "Noirstrap";
#endif
        public const string ProjectOwner = "noirstrap";
        public const string ProjectRepository = "cursed-blip/noirstrap";
        public const string ProjectDownloadLink = "https://github.com/cursed-blip/noirstrap/releases";
        public const string ProjectHelpLink = "https://github.com/noirstraplabs/noirstrap/wiki";
        public const string ProjectSupportLink = "https://github.com/cursed-blip/noirstrap/issues/new";
        public const string ProjectRemoteDataLink = "https://config.noirstrap.app/v1/Data.json";
        ...
        private static void MigrateVersionProfilesIfNeeded()
        {
            ...
            try
            {
                // white theme migration: old brown default -> white
                if (string.Equals(Settings.Prop.AccentColor, "#B2703E", StringComparison.OrdinalIgnoreCase))
                {
                    Settings.Prop.AccentColor = "#FFFFFF";
                    Logger.WriteLine(LOG_IDENT, "Migrated brown accent #B2703E -> white #FFFFFF");
                }
        ...
        {
            Noirstrap.Integrations.AssetProxy.AssetProxyManager.Stop();
