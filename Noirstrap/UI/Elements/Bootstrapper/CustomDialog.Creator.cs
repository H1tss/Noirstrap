...
namespace Noirstrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["NoirstrapCustomBootstrapper"] = HandleXmlElement_NoirstrapCustomBootstrapper_Fake,
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "NoirstrapCustomBootstrapper")
                throw new Exception("XML root is not a NoirstrapCustomBootstrapper");

            if (xml.Attribute("Version")?.Value != Version.ToString())
                throw new Exception("Unknown NoirstrapCustomBootstrapper version");
            ...
            // handle root
            HandleXmlElement_NoirstrapCustomBootstrapper(this, xml);
