    ...
    public class ChannelViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private async Task LoadRecentVersionsAsync()
        {
            ...
            void Populate(List<ClientVersionEntry> versions)
            {
                ...
                if (versions.Count == 0)
                    VersionListNote = "No builds found yet - launch Roblox through Noirstrap once and they will show up here.";
        ...
        private async Task PinSelectedVersionAsync()
        {
            ...
            VersionStatus = $"Pinned to {selected.VersionGuid}. Noirstrap will install that build on your next launch.";
        }
