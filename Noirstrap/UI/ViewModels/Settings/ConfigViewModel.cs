...
using Noirstrap.Models.Entities;
using Noirstrap.UI.Theming;
using CommunityToolkit.Mvvm.Input;

namespace Noirstrap.UI.ViewModels.Settings
{
    public class ConfigViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void SaveCurrent()
        {
            ...
            {
                Filter = "Noirstrap config (*.cfg)|*.cfg",
                FileName = "My Noirstrap setup.cfg",
        ...
        private void ImportFrom(string? path)
        {
            if (path is null)
            {
                ...
                {
                    Filter = "Noirstrap config (*.cfg;*.json)|*.cfg;*.json|All files (*.*)|*.*",
                    InitialDirectory = ConfigsDirectory
                };
            ...
            try
            {
                NoirstrapConfigPackage? package = JsonSerializer.Deserialize<NoirstrapConfigPackage>(File.ReadAllText(path));
        ...
        private void Write(string path)
        {
            ...
            var package = new NoirstrapConfigPackage
            {
        ...
        private void Apply(NoirstrapConfigPackage package)
        {
            ...
            Frontend.ShowMessageBox("Config loaded. Restart Noirstrap (and Roblox) for every change to take effect.", System.Windows.MessageBoxImage.Information);
        }
        ...
        private void ResetSettings()
        {
            ...
            Frontend.ShowMessageBox("Noirstrap settings restored to default.", System.Windows.MessageBoxImage.Information);
        }
