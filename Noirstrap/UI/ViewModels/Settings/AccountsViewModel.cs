...
namespace Noirstrap.UI.ViewModels.Settings
{
    public class AccountsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public string CookieHint => CookieAccess
            ? "Noirstrap can read your Roblox login. That's what the wardrobe needs, and it's what lets it remember the accounts you switch between. Cookies are encrypted with Windows and never leave this PC."
            : "Turn this on to use the wardrobe and to have Noirstrap remember your accounts. Nothing is sent anywhere, and the cookies stay encrypted with Windows.";
