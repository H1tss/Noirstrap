...
namespace Noirstrap.Models.Persistable
{
    public class Settings
    {
        ...
        // noirstrap configuration
        public BootstrapperStyle BootstrapperStyle { get; set; } = BootstrapperStyle.FluentAeroDialog;
        public BootstrapperIcon BootstrapperIcon { get; set; } = BootstrapperIcon.IconNoirstrap;
        ...
        // ===== ExploitStrap port: Versions Manager + downgrade (LIVE-locked) =====
        ...
        // ===== ExploitStrap port: executor tooling =====
        ...
        public bool NotifyOnAppUpdate { get; set; } = false;
        public string BloxGenApiKey { get; set; } = "";
        public string LuaObfuscatorApiKey { get; set; } = "";
        public string BypassToolsApiKey { get; set; } = "";
        public bool FFlagInjectorEnabled { get; set; } = true;
        public bool FFlagInjectorAutoInject { get; set; } = true;
        public string FFlagInjectorPythonPath { get; set; } = "";
        public string FFlagInjectorManagerPath { get; set; } = "";

        // ===== ExploitStrap port: BanAsync =====
