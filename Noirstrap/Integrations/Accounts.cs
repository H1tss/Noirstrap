...
using Noirstrap.Models;
using Noirstrap.Models.APIs.Roblox;

namespace Noirstrap.Integrations
{
    ...
    public static class Accounts
    {
        ...
        public static async Task<(bool Ok, string Message)> SaveCurrentAsync()
        {
            if (!App.Settings.Prop.AllowCookieAccess)
                return (false, "Noirstrap needs permission to read your Roblox cookie. Turn on \"Access your Roblox account\" on the Behaviour tab.");
            ...
            if (String.IsNullOrEmpty(cookie))
                return (false, "No Roblox account is signed in on this PC that Noirstrap can read.");
        ...
        public static (bool Ok, string Message) SwitchTo(long userId)
        {
            ...
            try
            {
                ...
                string backup = path + ".noirstrap-backup";
