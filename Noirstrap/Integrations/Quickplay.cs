...
namespace Noirstrap.Integrations
{
    public static class Quickplay
    {
        ...
        public static void LaunchDeeplink(string deeplink)
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, "Could not determine the Noirstrap executable path");
                return;
            }
        ...
        public static string CreateShortcut(QuickplayGame game)
        {
            ...
            if (!File.Exists(shortcutPath))
                throw new IOException("Windows would not let Noirstrap create the shortcut.");
