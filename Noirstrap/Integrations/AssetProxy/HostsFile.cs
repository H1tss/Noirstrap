...
namespace Noirstrap.Integrations.AssetProxy
{
    ...
    {
        public const string Marker = "# Noirstrap asset proxy entry";

        private const string EndMarker = "# end Noirstrap asset proxy entry";
        ...
        public static bool Apply(IEnumerable<string> hosts, out string error)
        {
            ...
            {
                error = "Noirstrap needs to run as administrator to redirect Roblox's asset hosts";
                return false;
            }
            catch (Exception ex)
            {
        ...
        public static bool Remove(out string error)
        {
            ...
            {
                error = "Noirstrap needs to run as administrator to restore the hosts file";
                return false;
            }
            catch (Exception ex)
            {
